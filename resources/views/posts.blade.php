    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card" style="color: black">
                <div class="position-absolute bg-dark px-3 py-2 text-white" style="background-color: rgba(0, 0, 0, 0.7)"><a href="/blog?category={{$post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</div>
                    @if($post->image)
